                ...
                <div class="card-body">
                    <form action="{{ route('wisata.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_wisata[]" autocomplete='off' class="form-control @error('nama_wisata.*') is-invalid @enderror">
                            @error('nama_wisata.*')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                            <input type="text" name="lokasi[]" autocomplete='off' class="form-control @error('lokasi.*') is-invalid @enderror">
                            @error('lokasi.*')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mt-3">
                            <a href="#" class="addwisata btn btn-success" style="float: right;"><i class="fa fa-plus"></i> Tambah Wisata</a>
                        </div>
